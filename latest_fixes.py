...
def restart_application():
    try:
        ...
        script = sys.argv[0]
        args = sys.argv[1:]
        # Start a new instance of the script in a detached process
        subprocess.Popen([python, script] + args, creationflags=subprocess.DETACHED_PROCESS | subprocess.CREATE_NEW_PROCESS_GROUP, close_fds=True)
