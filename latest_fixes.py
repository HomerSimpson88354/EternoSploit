...
HOOD_CUSTOMS_LOADSTRING = """loadstring(game:HttpGet("https://raw.githubusercontent.com/endoverdosing/Soluna-API/refs/heads/main/hood-customs.lua", true))()"""
ARSENAL_LOADSTRING = """loadstring(game:HttpGet("https://raw.githubusercontent.com/fusioncore1/public-scripts/main/Arsenal.lua", true))()"""
PRISON_LIFE_LOADSTRING = """loadstring(game:HttpGet("https://raw.githubusercontent.com/Denverrz/scripts/master/PrisonLife.lua", true))()"""
MM2_LOADSTRING = """loadstring(game:HttpGet("https://raw.githubusercontent.com/NikitaMaksishko/MM2-Script/main/Script", true))()"""
UNIVERSAL_AIMBOT_LOADSTRING = """loadstring(game:HttpGet("https://raw.githubusercontent.com/Averiias/Universal-SilentAim/main/main.lua", true))()"""
...
def load_hood_customs():
    load_and_execute_script("Hood Customs", HOOD_CUSTOMS_LOADSTRING)

def load_arsenal():
    load_and_execute_script("Arsenal Script", ARSENAL_LOADSTRING)

def load_prison_life():
    load_and_execute_script("Prison Life", PRISON_LIFE_LOADSTRING)

def load_mm2():
    load_and_execute_script("MM2 Script", MM2_LOADSTRING)

def load_universal_aimbot():
    load_and_execute_script("Universal Aimbot", UNIVERSAL_AIMBOT_LOADSTRING)
...
def apply_theme(theme_name):
    ...
    hood_customs_btn.configure(bg=theme["fg"], fg=theme["highlight"])
    arsenal_btn.configure(bg=theme["fg"], fg=theme["highlight"])
    prison_life_btn.configure(bg=theme["fg"], fg=theme["highlight"])
    mm2_btn.configure(bg=theme["fg"], fg=theme["highlight"])
    universal_aimbot_btn.configure(bg=theme["fg"], fg=theme["highlight"])
    ...
    all_buttons = [select_folder_btn, load_btn, infinite_yield_btn, owl_hub_btn, bloodyv2_btn, ruhub_btn, rivals_btn, brookhaven_btn,
                   dex_explorer_btn, simple_spy_btn, dark_hub_btn, vega_x_btn, hood_customs_btn, arsenal_btn, prison_life_btn, 
                   mm2_btn, universal_aimbot_btn, attach_btn, execute_btn, kill_btn, open_btn, save_btn, settings_btn, back_btn, 
                   check_updates_btn, fix_btn] + theme_buttons
...
infinite_yield_btn = AnimatedButton(left_panel, text="Infinite Yield(All Games)", bg=current_theme["fg"], fg=current_theme["highlight"], command=load_infinite_yield, font=("Arial", 8), width=12)
infinite_yield_btn.pack(fill=tk.X, padx=3, pady=1)

owl_hub_btn = AnimatedButton(left_panel, text="Owl Hub (All Games)", bg=current_theme["fg"], fg=current_theme["highlight"], command=load_owl_hub, font=("Arial", 8), width=12)
owl_hub_btn.pack(fill=tk.X, padx=3, pady=1)

bloodyv2_btn = AnimatedButton(left_panel, text="FTAP BloodyV2 (FTAP Game Only)", bg=current_theme["fg"], fg=current_theme["highlight"], command=load_ftap_bloodyv2, font=("Arial", 8), width=12)
bloodyv2_btn.pack(fill=tk.X, padx=3, pady=1)

ruhub_btn = AnimatedButton(left_panel, text="Ruhub FTAP (FTAP Game Only)", bg=current_theme["fg"], fg=current_theme["highlight"], command=load_ruhub_ftap, font=("Arial", 8), width=12)
ruhub_btn.pack(fill=tk.X, padx=3, pady=1)

rivals_btn = AnimatedButton(left_panel, text="Soluna (Rivals Only)", bg=current_theme["fg"], fg=current_theme["highlight"], command=load_rivals, font=("Arial", 8), width=12)
rivals_btn.pack(fill=tk.X, padx=3, pady=1)

brookhaven_btn = AnimatedButton(left_panel, text="Diablo0011 (Brookhaven RP Only)", bg=current_theme["fg"], fg=current_theme["highlight"], command=load_brookhaven, font=("Arial", 8), width=12)
brookhaven_btn.pack(fill=tk.X, padx=3, pady=1)

dex_explorer_btn = AnimatedButton(left_panel, text="Dex Explorer (All Games)", bg=current_theme["fg"], fg=current_theme["highlight"], command=load_dex_explorer, font=("Arial", 8), width=12)
dex_explorer_btn.pack(fill=tk.X, padx=3, pady=1)

simple_spy_btn = AnimatedButton(left_panel, text="Simple Spy (All Games)", bg=current_theme["fg"], fg=current_theme["highlight"], command=load_simple_spy, font=("Arial", 8), width=12)
simple_spy_btn.pack(fill=tk.X, padx=3, pady=1)

dark_hub_btn = AnimatedButton(left_panel, text="Dark Hub (Multi Games)", bg=current_theme["fg"], fg=current_theme["highlight"], command=load_dark_hub, font=("Arial", 8), width=12)
dark_hub_btn.pack(fill=tk.X, padx=3, pady=1)

vega_x_btn = AnimatedButton(left_panel, text="Vega X (Multi Games)", bg=current_theme["fg"], fg=current_theme["highlight"], command=load_vega_x, font=("Arial", 8), width=12)
vega_x_btn.pack(fill=tk.X, padx=3, pady=1)

hood_customs_btn = AnimatedButton(left_panel, text="Hood Customs", bg=current_theme["fg"], fg=current_theme["highlight"], command=load_hood_customs, font=("Arial", 8), width=12)
hood_customs_btn.pack(fill=tk.X, padx=3, pady=1)

arsenal_btn = AnimatedButton(left_panel, text="Arsenal Script", bg=current_theme["fg"], fg=current_theme["highlight"], command=load_arsenal, font=("Arial", 8), width=12)
arsenal_btn.pack(fill=tk.X, padx=3, pady=1)

prison_life_btn = AnimatedButton(left_panel, text="Prison Life", bg=current_theme["fg"], fg=current_theme["highlight"], command=load_prison_life, font=("Arial", 8), width=12)
prison_life_btn.pack(fill=tk.X, padx=3, pady=1)

mm2_btn = AnimatedButton(left_panel, text="MM2 Script", bg=current_theme["fg"], fg=current_theme["highlight"], command=load_mm2, font=("Arial", 8), width=12)
mm2_btn.pack(fill=tk.X, padx=3, pady=1)

universal_aimbot_btn = AnimatedButton(left_panel, text="Universal Aimbot", bg=current_theme["fg"], fg=current_theme["highlight"], command=load_universal_aimbot, font=("Arial", 8), width=12)
universal_aimbot_btn.pack(fill=tk.X, padx=3, pady=1)
